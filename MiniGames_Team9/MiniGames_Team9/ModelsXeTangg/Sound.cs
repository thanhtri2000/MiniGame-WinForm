...
namespace MiniGames_Team9
{
    ...
    class Sound
    {
        ...
        private static SoundPlayer start = new SoundPlayer(Properties.Resources.start1);
        private static SoundPlayer takeitem = new SoundPlayer(Properties.Resources.prop1);
